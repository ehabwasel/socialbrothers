    ...
    <div className="blog-list-container">
      {loading ? (
        ...
        <Message variant="danger">{error}</Message>
          ...
          <Row className="  d-flex justify-content-center " style={{margin:'0px'}}>
            <Col lg={5}  style={{margin:'50px 10px 50px 0px'}} md={10} xl={4} sm={10}>
              <Row className="  d-flex justify-content-center  " md={12} xl={12} sm={10} ><MessageForm /></Row>
            </Col>
            <Col  style={{margin:'50px 0px 50px 10px',backgroundColor:'white'}}lg={6} md={10} xl={5} sm={10}>
              <Row
